...
-- 4번
-- 도서관에서 대출 도서 장기 연체자 들을 찾아 이름을 게시하고자 한다. 그 대상들의
...
-- 5번
-- 입학정원이 20명 이상 30명 이하인 학과들의 학과 이름과 게열을 출력하시오.
...
-- 8번
-- 수강신청을 하려고 한다. 선수 과목 여부를 확인해야 하는데, 선수과목이 존재하는
